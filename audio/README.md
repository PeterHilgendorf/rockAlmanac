...
| `<artist>-sleep-history.md` | An episode's master script. |
| `<artist>-sleep-history.elevenlabs.txt` | The same, prepped for ElevenLabs (generated by prep_narration.py). |
| `<artist>-pronunciations.pls` / pronunciations.pls | Per-artist pronunciation dictionary (alias method). |

Episodes so far: **Fleetwood Mac** (1967–2022, ~4,300 words) and
**The Runaways** (1975–1979 and after, ~3,900 words). Both land inside
the thirty-to-sixty-minute window at a slow read.
